			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<form action="${pageContext.request.contextPath}/admin/doaddproduct" method="post">
								...
								<div class="row">
									<div class="row no-gutters">
										...
										<div class="col-12 col-sm-6 col-md-8">
											<input class="form-control" name="product.productName" />
										</div>
									</div>
									<div class="row no-gutters">
										<div class="col-6 col-md-4">
									...
									<div class="row no-gutters">
										...
										<div class="col-12 col-sm-6 col-md-8">
											<textarea cols="100" rows="15" name="product.description">Describe your Laptop by HTML code!
											</textarea>
										</div>
									</div>
									<div class="row no-gutters">
