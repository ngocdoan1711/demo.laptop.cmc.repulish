			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<form action="${pageContext.request.contextPath}/admin/doeditcategory"
							method="post">
								...
								<div class="row">
									<div class="row no-gutters">
										...
										<div class="col-12 col-sm-6 col-md-8">
											<input type="hidden" name="categoryId" value="<s:property value="category.categoryId"/>">
											<input class="form-control" name="category.categoryName" value="<s:property value="category.categoryName"/>">
										</div>
									</div>
									<div class="row no-gutters">
