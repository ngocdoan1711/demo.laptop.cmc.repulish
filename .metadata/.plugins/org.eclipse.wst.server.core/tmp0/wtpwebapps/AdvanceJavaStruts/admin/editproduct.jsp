			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<form action="${pageContext.request.contextPath}/admin/doeditproduct" method="post">
								...
								<div class="row">
									<div class="row no-gutters">
										...
										<div class="col-12 col-sm-6 col-md-8">
											...
											<input class="form-control" name="product.productName" value="<s:property value="product.productName"/>" />
										</div>
									</div>
									<div class="row no-gutters">
										<div class="col-6 col-md-4">
										...
										<div class="col-12 col-sm-6 col-md-8">
											...
											<s:iterator value="listCategory">
												<option value="<s:property value="categoryId"/>" <s:if test="%{categoryId == product.categoryId}">selected</s:if>> <s:property value="categoryName"/></option>
											</s:iterator>
											</select>
										</div>
									</div>
									<div class="row no-gutters">
										...
										<div class="col-12 col-sm-6 col-md-8">
											<input type="text" class="form-control" name="product.price" value="<s:property value="product.price"/>">
										</div>
									</div>
									<div class="row no-gutters">
										<div class="col-6 col-md-4">
										...
										<div class="col-12 col-sm-6 col-md-8">
											<textarea cols="100" rows="15" name="product.description"><s:property value="product.description"/>
										</textarea>
										</div>
									</div>
									<div class="row no-gutters">
										...
										<div class="col-12 col-sm-6 col-md-8">
											<input type="hidden" name="product.image" id="Image" value="<s:property value="product.image"/>" />
											<img class="small-img" src="<s:property value="product.image"/>">
