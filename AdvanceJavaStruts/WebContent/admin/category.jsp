			...
			<div class="row">
				<div class="col-lg-12" style="margin-top: 50px;">
					<div class="panel panel-default">
						...
						<form method="post"	action="${pageContext.request.contextPath}/admin/deletemultiplecategory">
							<table width="100%"
								...
								<s:iterator value="listCategory">
									<tr>
										...
										<input type="checkbox" class="chkCheckBoxId" name="deleteCategoryId" value="<s:property value="categoryId"/>">
										</label>
										</td>
