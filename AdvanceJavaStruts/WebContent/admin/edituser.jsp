								...
								<div class="row">
									<div class="row no-gutters">
										...
										<div class="col-12 col-sm-6 col-md-8">
											...
											<input class="form-control" name="user.userName" value="<s:property value="user.userName"/>">
										</div>
									</div>
									<div class="row no-gutters">
										<div class="col-6 col-md-4">
									...
									<div class="row no-gutters">
										...
										<div class="col-12 col-sm-6 col-md-8">
											<input class="form-control" name="user.phone" value="<s:property value="user.phone"/>">
										</div>
									</div>
									<div class="row no-gutters">
										<div class="col-6 col-md-4">
